...
{
  new (message_memory) webots_spot_msgs::msg::Int32(_init);
}

void Int32_fini_function(void * message_memory)
{
  auto typed_message = static_cast<webots_spot_msgs::msg::Int32 *>(message_memory);
  typed_message->~Int32();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int32_message_member_array[1] = {
  {
    ...
    offsetof(webots_spot_msgs::msg::Int32, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int32_message_members = {
  ...
  "Int32",  // message name
  1,  // number of fields
  sizeof(webots_spot_msgs::msg::Int32),
...
{
  return &::webots_spot_msgs::msg::rosidl_typesupport_introspection_cpp::Int32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_spot_msgs, msg, Int32)() {
  return &::webots_spot_msgs::msg::rosidl_typesupport_introspection_cpp::Int32_message_type_support_handle;
}
