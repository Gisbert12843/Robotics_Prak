...
static const _Legs_type_support_symbol_names_t _Legs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_spot_msgs, msg, Legs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_spot_msgs, msg, Legs)),
  }
};
...
{
  return &::webots_spot_msgs::msg::rosidl_typesupport_cpp::Legs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, webots_spot_msgs, msg, Legs)() {
  return get_message_type_support_handle<webots_spot_msgs::msg::Legs>();
}
