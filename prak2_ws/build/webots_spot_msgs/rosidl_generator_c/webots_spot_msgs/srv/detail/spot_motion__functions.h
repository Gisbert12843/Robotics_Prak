...
#ifndef WEBOTS_SPOT_MSGS__SRV__DETAIL__SPOT_MOTION__FUNCTIONS_H_
#define WEBOTS_SPOT_MSGS__SRV__DETAIL__SPOT_MOTION__FUNCTIONS_H_
...
/// Initialize srv/SpotMotion message.
/**
...
/// Finalize srv/SpotMotion message.
/**
...
/// Create srv/SpotMotion message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * webots_spot_msgs__srv__SpotMotion_Request__init().
...
/// Destroy srv/SpotMotion message.
/**
 * It calls
 * webots_spot_msgs__srv__SpotMotion_Request__fini()
...
/// Check for srv/SpotMotion message equality.
/**
...
/// Initialize array of srv/SpotMotion messages.
/**
...
/// Finalize array of srv/SpotMotion messages.
/**
 * It calls
 * webots_spot_msgs__srv__SpotMotion_Request__fini()
...
/// Create array of srv/SpotMotion messages.
/**
 * It allocates the memory for the array and calls
 * webots_spot_msgs__srv__SpotMotion_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SpotMotion messages.
/**
 * It calls
 * webots_spot_msgs__srv__SpotMotion_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SpotMotion message array equality.
/**
...
/// Copy an array of srv/SpotMotion messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * webots_spot_msgs__srv__SpotMotion_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_spot_msgs
...
/**
 * It calls
 * webots_spot_msgs__srv__SpotMotion_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_spot_msgs
...
/**
 * It allocates the memory for the array and calls
 * webots_spot_msgs__srv__SpotMotion_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_spot_msgs
...
/**
 * It calls
 * webots_spot_msgs__srv__SpotMotion_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WEBOTS_SPOT_MSGS__SRV__DETAIL__SPOT_MOTION__FUNCTIONS_H_
