...
static const _SpotMotion_Request_type_support_symbol_names_t _SpotMotion_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_spot_msgs, srv, SpotMotion_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_spot_msgs, srv, SpotMotion_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_spot_msgs, srv, SpotMotion_Request)() {
  return &::webots_spot_msgs::srv::rosidl_typesupport_c::SpotMotion_Request_message_type_support_handle;
}
...
static const _SpotMotion_Response_type_support_symbol_names_t _SpotMotion_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_spot_msgs, srv, SpotMotion_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_spot_msgs, srv, SpotMotion_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_spot_msgs, srv, SpotMotion_Response)() {
  return &::webots_spot_msgs::srv::rosidl_typesupport_c::SpotMotion_Response_message_type_support_handle;
}
...
static const _SpotMotion_type_support_symbol_names_t _SpotMotion_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_spot_msgs, srv, SpotMotion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_spot_msgs, srv, SpotMotion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, webots_spot_msgs, srv, SpotMotion)() {
  return &::webots_spot_msgs::srv::rosidl_typesupport_c::SpotMotion_service_type_support_handle;
}
